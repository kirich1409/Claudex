...
class MessageRepositoryTest {
    ...
    private suspend fun insertProjectAndSession(
        projId: String = "proj1",
        sessId: String = "sess1",
    ) {
    ...
    @Test
    fun MessageRepository_insert_and_observe_returnsMessages() =
        runTest {
    ...
    @Test
    fun MessageRepository_deleteBySession_removesAllMessages() =
        runTest {
            insertProjectAndSession()
